...
/*   Updated: 2023/04/06 21:17:45 by alpelliz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main_helper(int argnumber, char *argv, t_position *pos,
					t_fcounter *c);
int				x_close(void *data);
char			create_map(char *map, t_position *var);
int				check_map_helper(char *map, t_position *pos, int x,
					t_fcounter *c);
...
void			create_map_helper(t_position *var, char *line,
					int i, int j);
int				create_map_helper_split(t_position *var, char *line,
					int i, int j);
